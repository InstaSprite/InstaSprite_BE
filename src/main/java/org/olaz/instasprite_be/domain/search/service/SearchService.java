...
//import org.olaz.instasprite_be.domain.hashtag.exception.HashtagNotFoundException;
...
//import org.olaz.instasprite_be.domain.member.exception.MemberDoesNotExistException;
...
//import org.olaz.instasprite_be.domain.search.repository.RecentSearchRepository;
//import org.olaz.instasprite_be.domain.search.repository.SearchHashtagRepository;
//import org.olaz.instasprite_be.domain.search.repository.SearchMemberRepository;
//import org.olaz.instasprite_be.domain.search.repository.SearchRepository;
//import org.olaz.instasprite_be.global.error.exception.EntityTypeInvalidException;
...
//			.map(search -> switch (search.getDtype()) {
//                case "MEMBER" -> memberMap.get(search.getId());
//                case "HASHTAG" -> hashtagMap.get(search.getId());
//                default -> null;
//            })
//			.collect(Collectors.toList());
//	}
